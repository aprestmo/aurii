...
>
> Core is the system of record. It must remain usable independently of Studio and of commercial products. Direction: [`PRODUCT_STRATEGY.md`](PRODUCT_STRATEGY.md). Guardrails: [`COMPETITIVE_GUARDRAILS.md`](COMPETITIVE_GUARDRAILS.md).
